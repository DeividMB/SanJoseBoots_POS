...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-02-2026 a las 23:55:00
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_RegistrarVenta` (IN `p_NumeroTicket` VARCHAR(50), IN `p_UsuarioID` INT, IN `p_Subtotal` DECIMAL(10,2), IN `p_Descuento` DECIMAL(10,2), IN `p_IVA` DECIMAL(10,2), IN `p_Total` DECIMAL(10,2), IN `p_MetodoPago` VARCHAR(50), IN `p_Observaciones` TEXT, IN `p_DetallesJSON` JSON)   proc_label: BEGIN
    ...
    BEGIN
        SET v_Error = 1;
        ROLLBACK;
        SET v_Mensaje = 'Error al procesar la venta';
    END;
    
    -- Iniciar transacción
    START TRANSACTION;
    
    -- Validar que venga JSON de detalles
    IF p_DetallesJSON IS NULL OR JSON_LENGTH(p_DetallesJSON) = 0 THEN
        SELECT 
            0 as VentaID,
            'No se proporcionaron detalles de venta' as Mensaje,
            'ERROR' as Estado;
        ROLLBACK;
        LEAVE proc_label;
    END IF;
    ...
    WHILE v_DetalleIndex < v_TotalDetalles DO
        ...
        -- Verificar si viene descuento en el detalle
    ...
    -- Si llegamos aquí sin errores, hacer commit
    IF v_Error = 0 THEN
        COMMIT;
        SET v_Mensaje = 'Venta registrada exitosamente';
        
        -- ✅ RETORNAR RESULTADO CON SELECT (para que el controlador lo capture)
        SELECT 
...
(7, 3, 'PAN-001-30-AZ', '30', 'Azul Oscuro', 'Clásico', 550.00, 8, 4, 1, '2026-02-06 23:01:31'),
(8, 3, 'PAN-001-32-AZ', '32', 'Azul Oscuro', 'Clásico', 550.00, 4, 4, 1, '2026-02-06 23:01:31'),
(9, 3, 'PAN-001-34-NEG', '34', 'Negro', 'Clásico', 550.00, 2, 4, 1, '2026-02-06 23:01:31'),
...
(13, 5, 'SOM-001-7-BEI', '7', 'Beige', 'Texano', 1000.00, 1, 2, 1, '2026-02-06 23:01:31'),
...
(26, 6, 'ACC-001-U-CAF', 'Única', 'Café', 'Clásico', 280.00, 24, 8, 1, '2026-02-10 02:15:37'),
(27, 6, 'ACC-001-U-NEG', 'Única', 'Negro', 'Clásico', 280.00, 22, 8, 1, '2026-02-10 02:15:37'),
(31, 7, 'CHA-001-L-AZ', 'L', 'Azul', 'Clásico', 850.00, 7, 2, 1, '2026-02-16 16:30:35'),
(32, 7, 'CHA-001-M-AZ', 'M', 'Azul', 'Clásico', 850.00, 7, 2, 1, '2026-02-16 16:30:35'),
(33, 7, 'CHA-001-XL-NEG', 'XL', 'Negro', 'Clásico', 850.00, 5, 2, 1, '2026-02-16 16:30:35');
...
(1, 'Administrador del Sistema', 'admin@sanjoseboots.com', 'admin', '$2a$10$5ULwTtzJegPldP/yFLBSkOT1v7omEKIz5lvNySZlSoZxt.2/4pnly', 1, 1, '2026-02-06 23:01:30', '2026-02-16 16:44:14');
...
(10, 'TKT-20260216-860277', '2026-02-16 15:37:40', 1, 650.00, 0.00, 104.00, 754.00, 'Efectivo', 'COMPLETADA', NULL),
(11, 'TICKET-TEST-001', '2026-02-16 15:59:18', 1, 650.00, 0.00, 104.00, 754.00, 'Efectivo', 'COMPLETADA', 'Venta de prueba para verificar descuento de stock'),
(12, 'TICKET-TEST-002', '2026-02-16 16:06:20', 1, 550.00, 0.00, 88.00, 638.00, 'Efectivo', 'COMPLETADA', 'Prueba con nuevo procedimiento'),
(17, 'TKT-20260216-464753', '2026-02-16 16:21:04', 1, 650.00, 0.00, 104.00, 754.00, 'Efectivo', 'COMPLETADA', NULL),
(18, 'TKT-20260216-466108', '2026-02-16 16:21:06', 1, 650.00, 0.00, 104.00, 754.00, 'Efectivo', 'COMPLETADA', NULL),
(19, 'TKT-20260216-057135', '2026-02-16 16:30:57', 1, 650.00, 0.00, 104.00, 754.00, 'Efectivo', 'COMPLETADA', NULL),
(20, 'TKT-20260216-894458', '2026-02-16 16:44:54', 1, 850.00, 0.00, 136.00, 986.00, 'Efectivo', 'COMPLETADA', NULL),
(21, 'TKT-20260216-939788', '2026-02-16 16:45:39', 1, 280.00, 0.00, 44.80, 324.80, 'Efectivo', 'COMPLETADA', NULL),
(22, 'TKT-20260216-980294', '2026-02-16 16:46:20', 1, 5000.00, 0.00, 800.00, 5800.00, 'Efectivo', 'COMPLETADA', NULL),
(23, 'TKT-20260216-014823', '2026-02-16 16:46:54', 1, 4400.00, 0.00, 704.00, 5104.00, 'Efectivo', 'COMPLETADA', NULL),
(24, 'TKT-20260216-045975', '2026-02-16 16:47:26', 1, 2700.00, 0.00, 432.00, 3132.00, 'Efectivo', 'COMPLETADA', NULL);
...
--
ALTER TABLE `detalleventas`
  MODIFY `DetalleVentaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `ventas`
  MODIFY `VentaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
